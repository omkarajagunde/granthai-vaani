...
export default function GranthAICallPro() {
  ...
  const connect = () => {
    ...
    webSocket = new WebSocket("ws://granthai-vaani-production.up.railway.app");
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#195e40" }}>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        {/* Confirmation Step */}
        <AnimatePresence>
          {showConfirmation && !isCallInitiated && (
            <motion.div
              ...
              className="mb-8"
            >
              <Card className="bg-white/10 backdrop-blur-md border-2 border-green-400/50">
        ...
        <AnimatePresence>
          {isCallInitiated && (
            <motion.div
              ...
              className="mb-8"
            >
              <Card className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border-2 border-green-400">
                <CardContent className="p-8 text-center">
                  <motion.div
                    animate={{
                      scale: [1, 1.2, 1],
                  ...
                  >
                    <Phone className="w-full h-full text-green-400" />
                  </motion.div>
                  <h3 className="text-3xl font-bold text-white mb-4">Call Initiated Successfully! 🎉</h3>
                  <p className="text-white/80 text-lg mb-6">
                    Our AI assistant will call you at <strong>{capturedData.phone}</strong> shortly.
                  </p>
                  <div className="bg-black/30 rounded-lg p-4 mb-6">
                    <p className="text-green-400 font-mono">
                      Twilio Call ID: call_sim_{Date.now().toString().slice(-8)}
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <CardContent className="p-8">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-white mb-4">
                  Interested in integrating voice assistants into your workflows?
                </h2>
                <p className="text-xl" style={{ color: "#D8E9A8" }}>
                  Contact now!
                </p>
              </div>
